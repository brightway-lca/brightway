from brightway_projects.errors import InvalidName, NonUnique, InconsistentFields
...
def test_calculation_package():
    ...
    with tempfile.TemporaryDirectory() as td:
        fp = create_calculation_package(name="test-package", resources=resources, path=td)
        # Test data in fp
